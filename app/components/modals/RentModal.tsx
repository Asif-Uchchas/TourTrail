...
const RentModal = () => {
  ...
  if(step === STEPS.IMAGES){
    bodyContent=(
      <div className='flex flex-col gap-8'>
        ...
        subtitle='Show guests how the room would look like!'
        />
        <ImageUpload 
        value={imageSrc}
  ...
  if(step === STEPS.DESCRIPTION){
    bodyContent=(
      <div className='flex flex-col gap-8'>
        <Heading
        title='Add a description of the room'
        subtitle='Show guests how the room would feel like!'
        />
        <Input
        id="title"
        label="Title"
  ...
  if(step === STEPS.PRICE){
    bodyContent=(
      <div className='flex flex-col gap-8'>
        <Heading
        title='Set the price for this room'
        subtitle='This will be visible to all the guests'
        />
        <Input
        id='price'
        label='Price'
